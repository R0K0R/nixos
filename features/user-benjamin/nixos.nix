...
let
  cfg = config.my.user-benjamin;
in
{
  options.my.user-benjamin = {
    enable = lib.mkEnableOption "the benjamin user account and its home-manager identity";
    ...
    hashedPasswordFile = lib.mkOption {
      ...
      default = null;
      example = "/etc/nixos/secrets/hashed-password-benjamin";
      description = ''
