# Translated from sodiboo/niri-flake default-config.kdl.nix (upstream niri defaults).
# Keep in sync when bumping niri — see resources/default-config.kdl in niri.
{
  "Mod+Shift+Slash".action.show-hotkey-overlay = [ ];

  /*
    Omit XF86 volume keys: DMS niri.enableKeybinds binds them to `dms ipc`; duplicating wpctl errors.
    Mod+Comma / Mod+I vs DMS: overrides live in features/niri/home.nix (mkForce).
  */
