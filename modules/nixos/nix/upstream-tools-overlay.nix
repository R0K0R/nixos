...
# Only the BUILD platform. The march'd HOST set keeps the fork's packages and
# its tuning; see the header for why this replaces a runtime classifier.
if ((prev.stdenv.hostPlatform.gcc or { }).arch or "") != "" then
  { }
