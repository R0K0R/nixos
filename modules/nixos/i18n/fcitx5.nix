...

{
  i18n.inputMethod = {
    ...
    fcitx5 = {
      ...
      /*
        Global options + IME profile live under Home Manager (~/.config/fcitx5/{config,profile})
        so the user dir is the single source of truth instead of merging /etc vs ~/.config.
      */
    };
  };
